...
Modes:
  ...
  tv-route-planner-refuel-log Run route planner empty-fuel refuel recovery log
  ...
  tv-levo-same-port-sellback-log Run Levo source-observed same-port sellback log
  tv-commodity-buy-blocked-recovery-log Run commodity blocked-buy then buy recovery log
  tv-commodity-partial-hold-recovery-log Run commodity partial-hold buy recovery log
  tv-commodity-sell-blocked-recovery-log Run commodity blocked-sell then buy/sell recovery log
  tv-commodity-unavailable-recovery-log Run commodity unavailable-market then relocation recovery log
  tv-cross-market-trade-log Run cross-market trade spread log
  tv-max-hold-trade-log Run max-hold multi-lot trade spread log
  tv-trade-refuel-profit-log Run trade-route refuel/profit loop log
  tv-cargo-expansion-trade-log Run Cargo Pod capacity-expansion trade log
  tv-fuel-reserve-upgrade-log Run Auxiliary Fuel Tank reserve-upgrade log
  tv-balanced-upgrade-trade-log Run balanced cargo/fuel/hull upgrade budget log
  tv-hull-plating-repair-log Run Hull Plating purchase/repair loop log
  tv-upgrade-readiness-log Run upgrade readiness service/outfit/weapon/ship log
  tv-upgrade-affordability-log Run Light Freighter affordability trade-funding log
  tv-mission-offer-scan-log Run Mission Computer offer scan log
  ...
  tv-mission-scan-recovery-log Run mission scan-failure follow-up recovery log
  ...
  tv-shipyard-cargo-guardrail-log Run shipyard cargo downsizing guardrail log
  tv-outfitter-purchase-guardrail-log Run outfitter/shipyard purchase blocked/recovery log
  tv-repair-service-log Run landed repair service/hull restoration log
  tv-repair-credit-recovery-log Run insufficient-credit repair recovery log
  ...
  tv-pirate-loaded-cargo-avoidance-log Run pirate evasion with preserved mission/trade cargo log
  ...
  tv-combat-reward-salvage-log Run combat reward plus salvage pickup coupling log
  ...
  tv-cargo-salvage-recovery-log Run full-hold cargo salvage recovery log
  ...
  tv-light-freighter-capacity-trade-log Run Light Freighter capacity trade log
  ...
  tv-light-freighter-deadline-refuel-delivery-log Run Light Freighter deadline refuel delivery log
  ...
  tv-mission-story-gate-log Run mission story/exclusion gate log
  tv-mission-alignment-gate-log Run mission alignment story/reputation/legal gate log
  tv-mission-alignment-requirement-log Run alignment branch requirement recovery log
  ...
  tv-contraband-bribe-recovery-log Run bribable contraband scan recovery log
...
case "$mode" in
    ...
    self-test)
        ...
        ;;
    tv-movement-log|tv-afterburner-log|tv-travel-event-log|tv-landed-ui-matrix|tv-service-provisioning-log|tv-map-route-log|tv-route-invalid-log|tv-route-clear-log|tv-route-clear-reselect-log|tv-route-jump-log|tv-route-land-refuel-log|tv-route-planner-refuel-log|tv-low-fuel-jump-log|tv-near-center-jump-log|tv-commodity-trade-log|tv-levo-same-port-sellback-log|tv-commodity-buy-blocked-recovery-log|tv-commodity-partial-hold-recovery-log|tv-commodity-sell-blocked-recovery-log|tv-commodity-unavailable-recovery-log|tv-cross-market-trade-log|tv-max-hold-trade-log|tv-trade-refuel-profit-log|tv-cargo-expansion-trade-log|tv-fuel-reserve-upgrade-log|tv-balanced-upgrade-trade-log|tv-hull-plating-repair-log|tv-upgrade-readiness-log|tv-upgrade-affordability-log|tv-mission-offer-scan-log|tv-mission-chain-offer-log|tv-mission-chain-lock-log|tv-mission-alignment-branch-log|tv-mission-alignment-return-log|tv-mission-alignment-delivery-log|tv-mission-route-hint-log|tv-mission-trade-destination-sale-log|tv-chapter-one-trade-carryover-log|tv-mission-trade-return-margin-log|tv-trade-margin-choice-log|tv-mission-abort-log|tv-mission-abort-reaccept-log|tv-mission-abort-forbidden-log|tv-mission-abort-penalty-log|tv-mission-auto-abort-log|tv-mission-scan-failure-log|tv-mission-scan-recovery-log|tv-mission-deadline-failure-log|tv-mission-deadline-last-day-log|tv-mission-deadline-completed-log|tv-mission-deadline-recovery-log|tv-mission-deadline-sequential-log|tv-mission-deadline-abort-log|tv-mission-deadline-trade-carryover-log|tv-mission-log-history-log|tv-active-mission-deadline-log|tv-first-mission-delivery-log|tv-pilot-save-resume-log|tv-outfitter-shipyard-log|tv-shipyard-cargo-guardrail-log|tv-outfitter-purchase-guardrail-log|tv-repair-service-log|tv-repair-credit-recovery-log|tv-gameplay-curriculum-help-log|tv-starting-equipment-log|tv-pirate-avoidance-log|tv-pirate-loaded-cargo-avoidance-log|tv-combat-log|tv-combat-reward-log|tv-combat-reward-salvage-log|tv-combat-guardrail-log|tv-player-disabled-log|tv-shield-recharge-log|tv-retaliation-log|tv-projectile-motion-log|tv-explosion-log|tv-cargo-salvage-log|tv-cargo-salvage-recovery-log|tv-secondary-weapon-log|tv-target-selection-log|tv-autopilot-log|tv-navigation-guardrail-log|tv-legal-status-log|tv-legal-docking-log|tv-legal-service-gate-log|tv-weapon-reputation-gate-log|tv-weapon-credit-gate-log|tv-weapon-availability-gate-log|tv-weapon-inventory-stack-log|tv-weapon-secondary-activation-log|tv-weapon-mission-cargo-log|tv-weapon-trade-cargo-log|tv-weapon-legal-docking-log|tv-light-freighter-capacity-trade-log|tv-light-freighter-bulk-margin-log|tv-light-freighter-bulk-mission-margin-log|tv-light-freighter-refuel-mission-margin-log|tv-light-freighter-deadline-refuel-delivery-log|tv-light-freighter-mission-trade-log|tv-light-freighter-repair-trade-log|tv-light-freighter-repair-mission-trade-log|tv-light-freighter-repair-refuel-mission-trade-log|tv-light-freighter-deadline-repair-refuel-log|tv-legal-patrol-posture-log|tv-mission-legal-eligibility-log|tv-mission-story-gate-log|tv-mission-alignment-gate-log|tv-mission-alignment-requirement-log|tv-legal-consequence-log|tv-legal-clemency-log|tv-contraband-scan-log|tv-contraband-risk-log|tv-contraband-bribe-recovery-log|tv-contraband-scan-trade-log|tv-contraband-clemency-funding-log)
