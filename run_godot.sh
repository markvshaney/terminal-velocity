...
Modes:
  ...
  tv-cargo-expansion-trade-log Run Cargo Pod capacity-expanded trade loop log
  tv-fuel-reserve-upgrade-log Run Auxiliary Fuel Tank reserve-upgrade loop log
  tv-balanced-upgrade-trade-log Run balanced upgrade budget/trade loop log
