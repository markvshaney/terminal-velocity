...
- [x] Ship/outfit comparison and upgrade consequence surfaces
  ...
  - Next action: persist purchased outfits/weapons/ship across F6 save and title-screen Open Pilot resume, then gather original-runtime outfitter/shipyard purchase traces on a disposable non-strict pilot before claiming Classic fidelity.
