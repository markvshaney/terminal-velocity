...
- [x] Automated gameplay learning harness and skill curriculum
  ...
  - Next action: decide which scenario outcomes should become in-game tutorial/hint surfaces, then gather original-runtime evidence for pirate avoidance and combat on disposable non-strict pilots only after controls and save safety are understood.
