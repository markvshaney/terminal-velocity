...
def _scan_static_topology_source(state: dict[str, Any], action: dict[str, Any], trace: list[dict[str, Any]]) -> bool:
    ...
    trace.append({
        ...
        'systWordDomainCoverageSourceLabel': syst_word_domain_coverage.get('sourceLabel'),
        'systWordDomainCoverageOracleStatus': syst_word_domain_coverage.get('oracleStatus'),
