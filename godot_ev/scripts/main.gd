...
func _combat_reward_inventory_line() -> String:
	...
	return "Combat rewards: %d disable(s), %d credits — TV combat-reward scaffold; Classic bounty behavior pending" % [combat_reward_history.size(), total_credits]
