param(
    ...
    [switch]$CommodityPartialHoldRecoveryLog,
    ...
    [switch]$ShipyardCargoGuardrailLog,
    [switch]$OutfitterPurchaseGuardrailLog,
    [switch]$RepairServiceLog,
    [switch]$RepairCreditRecoveryLog,
...
} elseif ($RoutePlannerRefuelLog) {
    & $Godot --headless --path $Project -- --tv-route-planner-refuel-log
...
} elseif ($CommodityPartialHoldRecoveryLog) {
    & $Godot --headless --path $Project -- --tv-commodity-partial-hold-recovery-log
...
} elseif ($CargoExpansionTradeLog) {
    & $Godot --headless --path $Project -- --tv-cargo-expansion-trade-log
} elseif ($FuelReserveUpgradeLog) {
...
} elseif ($MissionAlignmentDeliveryLog) {
    & $Godot --headless --path $Project -- --tv-mission-alignment-delivery-log
...
} elseif ($MissionTradeReturnMarginLog) {
    & $Godot --headless --path $Project -- --tv-mission-trade-return-margin-log
} elseif ($TradeMarginChoiceLog) {
    & $Godot --headless --path $Project -- --tv-trade-margin-choice-log
...
} elseif ($MissionScanRecoveryLog) {
    & $Godot --headless --path $Project -- --tv-mission-scan-recovery-log
...
} elseif ($ShipyardCargoGuardrailLog) {
    & $Godot --headless --path $Project -- --tv-shipyard-cargo-guardrail-log
} elseif ($OutfitterPurchaseGuardrailLog) {
    & $Godot --headless --path $Project -- --tv-outfitter-purchase-guardrail-log
} elseif ($RepairServiceLog) {
    & $Godot --headless --path $Project -- --tv-repair-service-log
} elseif ($RepairCreditRecoveryLog) {
    & $Godot --headless --path $Project -- --tv-repair-credit-recovery-log
...
} elseif ($CombatRewardSalvageLog) {
    & $Godot --headless --path $Project -- --tv-combat-reward-salvage-log
...
} elseif ($LightFreighterCapacityTradeLog) {
    & $Godot --headless --path $Project -- --tv-light-freighter-capacity-trade-log
} elseif ($LightFreighterBulkMarginLog) {
...
} elseif ($LightFreighterDeadlineRefuelDeliveryLog) {
    & $Godot --headless --path $Project -- --tv-light-freighter-deadline-refuel-delivery-log
